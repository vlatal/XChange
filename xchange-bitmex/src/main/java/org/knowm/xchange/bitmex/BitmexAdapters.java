...
public class BitmexAdapters {
  ...
  public static OrderBook adaptOrderBook(BitmexDepth bitmexDepth, CurrencyPair currencyPair) {
    ...
    return new OrderBook(DateUtils.fromMillisToZonedDateTime(Math.max(asksOrdersContainer.getTimestamp(), bidsOrdersContainer.getTimestamp())), asksOrdersContainer.getLimitOrders(), bidsOrdersContainer.getLimitOrders());
  }
  ...
  public static Trade adaptTrade(BitmexPublicTrade bitmexPublicTrade, CurrencyPair currencyPair) {
    ...
    ZonedDateTime timestamp = bitmexPublicTrade.getTime();
  ...
  public static Wallet adaptWallet(Map<String, BigDecimal> bitmexWallet) {
    ...
    for (Map.Entry<String, BigDecimal> balancePair : bitmexWallet.entrySet()) {
  ...
  public static OpenOrders adaptOpenOrders(Map<String, BitmexOrder> bitmexOrders) {
    ...
    for (Map.Entry<String, BitmexOrder> bitmexOrderEntry : bitmexOrders.entrySet()) {
  ...
  public static LimitOrder adaptLimitOrder(BitmexOrder bitmexOrder, String id) {
    ...
    ZonedDateTime timestamp = DateUtils.fromSecondsToZonedDateTime((long) (bitmexOrder.getOpenTimestamp()));
  ...
  public static UserTrades adaptTradesHistory(Map<String, BitmexTrade> bitmexTrades) {
    ...
    for (Map.Entry<String, BitmexTrade> bitmexTradeEntry : bitmexTrades.entrySet()) {
