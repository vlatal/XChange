...
public class AbucoinsCreateOrderResponse {
  ...
  public AbucoinsCreateOrderResponse(@JsonProperty("product_id") String productID,
  ...
  public String toString() {
      return "AbucoinsCreateOrderResponse [productID=" + productID + ", used=" + used + ", size=" + size + ", price="
          + price + ", id=" + id + ", side=" + side + ", type=" + type + ", timeInForce=" + timeInForce
          + ", postOnly=" + postOnly + ", createdAt=" + createdAt + ", filledSize=" + filledSize + ", fillFees="
          + fillFees + ", executedValue=" + executedValue + ", status=" + status + ", reason=" + reason
          + ", settled=" + settled + ", hidden=" + hidden + ", stp=" + stp + ", message=" + message + "]";
  }
}
