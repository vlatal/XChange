...
public class BleutradeUtilsTest {
  ...
  public void shouldConvertStringToDate() {
    assertThat(BleutradeUtils.toDate("2015-12-14 11:27:16.323").toInstant().toEpochMilli()).isEqualTo(1450092436323L);
    assertThat(BleutradeUtils.toDate("2015-12-14 11:15:25").toInstant().toEpochMilli()).isEqualTo(1450091725000L);
